...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@Pickle-Power-Sports/ui/components/sheet";
import { Skeleton } from "@Pickle-Power-Sports/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@Pickle-Power-Sports/ui/components/tooltip";
import { useIsMobile } from "@Pickle-Power-Sports/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: Persisting the sidebar state mirrors the shadcn sidebar behavior.
